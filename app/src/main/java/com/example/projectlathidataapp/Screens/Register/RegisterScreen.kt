...
@Composable
fun RegisterScreen(navController: NavController, viewModel: RegisterViewModel= hiltViewModel(), activity: Activity,) {
    ...
    Column {
        ...
        Column(
            ...
            Button(
                onClick = {
                    scope.launch {
                        viewModel.registerUser(UserName,username, password)
                    }
                },
                modifier = Modifier
                    .fillMaxWidth()
